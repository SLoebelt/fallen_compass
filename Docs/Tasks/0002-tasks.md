...
- [x] **Implementation (FCLevelManager.cpp)**
  ...
  - [x] Add private members to FCLevelManager.h:
...
- [x] **Testing After Step 5.2.2** ✅ CHECKPOINT
  - [x] Compile C++ code
  - [x] PIE in L_Office
  - [x] Test from console: `CE GetGameInstance()->GetSubsystem<UFCLevelManager>()->LoadLevel(TEXT("Lvl_TopDown"), false)`
  - [x] Verify fade out occurs ✅
  - [x] Verify level loads (returns to main menu) ✅
  - [x] Check Output Log: "LoadLevel: Loading L_MainMenu" ✅
  - [x] No crashes
