...
Think of creating a roadmap for implementation in form of a detailed tasklist. every task needs to be "completeable", prerequisits have to be implemented before.
